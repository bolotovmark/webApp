...
def parse_weather():
    ...
    for part in response['forecasts']:
        ...
        print(morning_condition, morning_cloudness, morning_temp, morning_wind)
        print(day_condition, day_cloudness, day_temp, day_wind)
        print(evening_condition, evening_cloudness, evening_temp, evening_wind)
        print(night_condition, night_cloudness, night_temp, night_wind)
